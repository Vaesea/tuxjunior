//  $Id: Sector.cs 5671 2008-07-18 12:11:23Z mmlosh $
using System;
...
public sealed class Sector : ICustomLispSerializer {
	...
	private static int CompareTypeNames(Type x, Type y) {
		...
		//TuxjuniorObjectAttribute oax = (TuxjuniorObjectAttribute)Attribute.GetCustomAttribute(x, typeof(TuxjuniorObjectAttribute));
		//if (oax == null) return x.Name.CompareTo(y.Name);
		//TuxjuniorObjectAttribute oay = (TuxjuniorObjectAttribute)Attribute.GetCustomAttribute(y, typeof(TuxjuniorObjectAttribute));
