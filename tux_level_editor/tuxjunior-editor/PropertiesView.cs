//  $Id: PropertiesView.cs 5761 2008-08-31 19:32:56Z mmlosh $
using System;
using System.IO;
		...
		try {
			...
			if(field.Type == typeof(string)) {
				...
				throw new ApplicationException(
					...
					"If you are a developer, please fix it, else report this full error message and what you did to cause it to the tuxjunior developers.");
			}
			command.Do();
