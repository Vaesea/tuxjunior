...
//
//  Modified for use with TuxJunior 2012 slacker@gluebox.com
//  
...
public sealed class Tileset {
	...
	/// <param name="Resourcepath">A path relative to the data folder of TuxJunior.</param>
	public Tileset(string Resourcepath) {
		baseDir = ResourceManager.Instance.GetDirectoryName(Resourcepath);
		List TilesL = Util.Load(Resourcepath, "tuxjunior-tiles");
