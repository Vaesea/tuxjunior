...
#
# $Id: levelconverter-0.1.3_0.2.0.pl 3774 2006-06-26 22:54:26Z sommer $
#
...
# extract (tuxjunior-level ...) list from stdin
$all = join("", <STDIN>);
if ($all !~ m{\(tuxjunior-level\s+(.*)\s*\)}s) { die("Not a tuxjunior level"); }
$level = $1;
