//  $Id: resources.cpp 5265 2008-01-08 00:10:32Z matzeb $
//
//  SuperTux
...
void load_shared()
{
  ...
  fire_tux->body = sprite_manager->create("images/creatures/nolok/body.sprite");
  fire_tux->arms = sprite_manager->create("images/creatures/nolok/arms.sprite");
  fire_tux->feet = sprite_manager->create("images/creatures/nolok/feet.sprite");
