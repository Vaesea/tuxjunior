//  $Id: tile_set.cpp 5266 2008-01-08 00:28:50Z matzeb $
//
//  SuperTux
  ...
  : tiles_path(""), tiles_loaded(true)
{
  ...
  const lisp::Lisp* tiles_lisp = root->get_lisp("tuxjunior-tiles");
  if(!tiles_lisp)
    throw std::runtime_error("file is not a tuxjunior tiles file.");
