//  $Id: title.cpp 5113 2007-06-24 10:20:19Z sommer $
//
//  SuperTux
...
TitleScreen::draw(DrawingContext& context)
{
  ...
  context.draw_text(white_small_text, " " PACKAGE_VERSION "\n",
      Vector(5, SCREEN_HEIGHT - 59), ALIGN_LEFT, LAYER_FOREGROUND1);
  context.draw_text(white_small_text,
      _(
"Copyright (c) 2007-2009 Tux Junior Devel Team\n"
"Copyright (c) 2002-2008 Super Tux Devel Team\n"
"This game comes with ABSOLUTELY NO WARRANTY. This is free software, and you are welcome to\n"
"redistribute it under certain conditions; see the file COPYING for details.\n"
),
      Vector(5, SCREEN_HEIGHT - 59 + white_small_text->get_height() + 5),
...
TitleScreen::get_slotinfo(int slot)
{
  ...
  try {
    ...
    const lisp::Lisp* savegame = root->get_lisp("tuxjunior-savegame");
    if(!savegame)
      throw std::runtime_error("file is not a tuxjunior-savegame.");
