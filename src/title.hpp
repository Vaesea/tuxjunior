//  $Id: title.hpp 5235 2007-12-26 01:54:49Z sommer $
//
//  SuperTux
...
//  02111-1307, USA.
#ifndef TUXJUNIOR_TITLE_H
#define TUXJUNIOR_TITLE_H
...
/**
 * Screen that displays the TuxJunior logo, lets players start a new game, etc.
 */
