//  $Id: main.cpp 5253 2008-01-05 23:19:13Z wansti $
//
//  SuperTux
...
static void init_physfs(const char* argv0)
{
  ...
  const char* application = "tuxjunior2"; //instead of PACKAGE_NAME so we can coexist with MS1
...
#ifdef MACOSX
{
  using namespace tuxjunior_apple;
...
static void print_usage(const char* argv0)
{
  ...
  fprintf(stderr,
          _("Options:\n"
            ...
            "  -g, --geometry WIDTHxHEIGHT  Run TuxJunior in given resolution\n"
            "  -a, --aspect WIDTH:HEIGHT    Run TuxJunior with given aspect ratio\n"
            "  --disable-sfx                Disable sound effects\n"
            "  --disable-music              Disable music\n"
            "  --help                       Show this help message\n"
            "  --version                    Display TuxJunior version and quit\n"
...
*/
  ...
  // set icon
  #ifdef MACOSX
  const char* icon_fname = "images/engine/icons/tuxjunior-256x256.png";
  #else
  const char* icon_fname = "images/engine/icons/tuxjunior.xpm";
  #endif
